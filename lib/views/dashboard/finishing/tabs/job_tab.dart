...
class FinishingJobTab extends StatelessWidget {
  const FinishingJobTab({super.key});
        ...
        return const Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text('Tidak ada job finishing saat ini',
                  style:
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _row(Icons.format_list_numbered, 'Jumlah',
              '${job.jumlahTarget} pcs'),
...
class _UploadSheet extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text('Upload Bukti Finishing',
              style:
                  TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
          const Text('Foto harus jelas memperlihatkan hasil finishing',
  ...
  void _showPilih(BuildContext context, FinishingController c) {
    showModalBottomSheet(
      context: context,
      builder: (_) => SafeArea(
        child: Column(
