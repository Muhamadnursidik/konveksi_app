...
class PenjahitRiwayatTab extends StatelessWidget {
  const PenjahitRiwayatTab({super.key});
...
class _RiwayatCard extends StatelessWidget {
  final PenjahitRiwayatModel item;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _row(Icons.calendar_today_outlined, 'Tanggal', item.tanggal),
              ],
            ),
          ),
        ],
